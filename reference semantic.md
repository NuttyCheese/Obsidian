...
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- | ----------------------------------------- | ------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| **[[Value semantic]]**    | [[struct]], [[enum]], [[tuple]], [[Array]], [[Dictionary]], [[Set]], [[String]], [[Data]], [[Date]], [[CGPoint]] и т.д. | Копируется полностью (CoW — [[copy-on-write]]) | Изменение одной копии не влияет на другие | Да (если все свойства Sendable)             | `var a = [1,2]; var b = a; b.append(3); // a остаётся [1,2]`                                    |
