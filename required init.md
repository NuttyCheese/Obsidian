Вот **полное, подробное и максимально понятное** объяснение **`required init`** в Swift (актуально на 2026 год, Swift 6+).
...
Удачи с правильной и безопасной инициализацией классов в Swift! 🏗️