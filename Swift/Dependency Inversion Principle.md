...
- [[class]] / ViewModel / UseCase / Interactor **не должны** напрямую создавать или использовать конкретные реализации ([[URLSession]], [[Core Data]], [[Swift/Realm]], [[Firebase]] и т.д.)  
