Вот подробная статья для Obsidian по термину **AVCaptureConnection** в контексте iOS-разработки на Swift/UIKit. Текст содержит определения, архитектуру, схемы работы, детальное описание свойств и методов, примеры кода от простого к сложному (настройка ориентации, стабилизация, масштабирование, зеркалирование), best practices и теги.
