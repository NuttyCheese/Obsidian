Вот подробная статья для Obsidian по термину **AVCaptureMetadataInput** в контексте iOS-разработки на Swift/UIKit. Текст содержит определения, архитектуру, сравнение с другими входами, детальное описание API, примеры кода и теги.
