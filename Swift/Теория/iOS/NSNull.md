...
| --------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- | ------------------------------------------------------- |
| Получение данных из **[[Objective-C]] [[API]]** ([[NSDictionary]], [[NSArray]], [[Swift/UserDefaults]], [[Core Data]], [[KVC]]/[[KVO]]) | Многие старые API используют NSNull вместо nil | Приводи сразу к Optional: `value as? String ?? nil`     |
