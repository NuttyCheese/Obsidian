...
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| Вызовы **Objective-C API** ([[UIKit]], [[AppKit]], Core [[Foundation]], Core Animation, Core Graphics, [[Core Data]], [[Swift/UserDefaults]] и т.д.) | Многие методы возвращают/принимают NSValue (например, [[CGPoint]], [[CGRect]], CGAffineTransform) | Приводи сразу к Swift-типу: `value.cgPointValue`, `value.cgRectValue` |
