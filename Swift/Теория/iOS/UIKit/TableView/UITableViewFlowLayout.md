...
| Что Apple показывает на WWDC?       | Только compositional layout, DiffableDataSource, List в SwiftUI |
...
Удачи с чистыми, адаптивными и современными списками в твоём проекте! 📱✨