...
| Копирование enum              | ~2 нс        | ~5–10 нс                    | ~1–5 мкс ([[Copy-On-Write\|COW]]) |
...
- Большие данные внутри enum — копируются по значению ([[Copy-On-Write|COW]]), но всё равно дороже, чем ссылка (class)
