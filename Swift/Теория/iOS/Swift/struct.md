...
| ARC (счётчик ссылок)            | Нет                                          | Есть                                         | Нет retain cycles     |
| Copy-on-Write                   | Да (для Array, String, Set, Dictionary)      | Нет                                          | Экономия памяти       |
...
Удачи с чистыми, безопасными и производительными структурами в твоём проекте! 🧱