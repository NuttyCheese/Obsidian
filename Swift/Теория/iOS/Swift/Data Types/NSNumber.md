...
- лучше интегрируются с [[generic]], [[Codable]], [[SwiftUI]], [[Combine]], [[async]]/[[await]]  
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- | ------------------------------------------------------------------- |
| Вызовы **[[Objective-C]] [[API]]** ([[UIKit]], [[AppKit]], Core Foundation, [[Swift/Теория/Хранение данных/UserDefaults]], [[Core Data]], [[KVC]]/[[KVO]], NSNumberFormatter и т.д.) | Многие методы возвращают/принимают NSNumber    | Приводи сразу к Swift-типу: `number as? Int` / `number.doubleValue` |
