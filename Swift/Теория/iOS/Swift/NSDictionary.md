...
| ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | -------------------------------------------------------- |
| Вызовы **[[Objective-C]] [[API]]** ([[UIKit]], [[AppKit]], Core [[Foundation]], [[Swift/Теория/Хранение данных/UserDefaults]], [[Core Data]], [[KVC]]/[[KVO]] и т.д.) | Многие методы возвращают/принимают NSDictionary/NSMutableDictionary | Приводи сразу к `[AnyHashable: Any]` или `[String: Any]` |
