...
В 2026 году он **не используется** в стандартной реализации [[Dictionary]] и [[Set Collection]] в [[Swift]] (там применяется **open addressing** с quadratic probing и Robin Hood hashing), но остаётся важным для:
