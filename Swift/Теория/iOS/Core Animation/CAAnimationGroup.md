Вот подробная статья для Obsidian по термину **CAAnimationGroup** в контексте iOS-разработки на Swift/UIKit. Текст содержит определения, архитектуру, детальное описание свойств, сравнение с индивидуальными анимациями, примеры кода от простого к сложному (параллельные и последовательные анимации, синхронизация), best practices и теги.
