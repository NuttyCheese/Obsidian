Вот подробная статья для Obsidian по термину **CABasicAnimation** в контексте iOS-разработки на Swift/UIKit. Текст содержит определения, архитектуру, детальное описание свойств, сравнение с другими типами анимаций, примеры кода от простого к сложному (анимация различных свойств, управление временем, делегаты), best practices и теги.
