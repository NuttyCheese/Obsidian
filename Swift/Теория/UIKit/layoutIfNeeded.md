...
Он нужен в ситуациях, когда вы **не можете ждать** следующего кадра рендеринга (next run loop), а вам **прямо сейчас** нужны актуальные размеры/положения после изменения constraints или frame.
...
Удачи с точными размерами и без лагов в layout в Swift! 📏