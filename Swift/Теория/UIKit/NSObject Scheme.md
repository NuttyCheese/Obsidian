...
| 3   | [[Swift/Расширения/UIView]]           | UIResponder            | NSObject → UIResponder → UIView                           | Базовый визуальный элемент                |
...
| 16  | [[Swift/Расширения/UITableView]]      | UIScrollView           | … → UIView → UIScrollView → UITableView                   | Таблица (список)                          |
| 17  | [[Swift/Расширения/UICollectionView]] | UIScrollView           | … → UIView → UIScrollView → UICollectionView              | Коллекция / кастомные layouts             |
