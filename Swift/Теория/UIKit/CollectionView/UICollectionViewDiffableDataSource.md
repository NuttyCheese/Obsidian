`UICollectionViewDiffableDataSource` - это класс, введенный в [[iOS]] 13, который упрощает управление данными в коллекциях ([[Swift/Теория/UIKit/CollectionView/UICollectionView]]). Он работает по аналогии с [[UITableViewDiffableDataSource]], но предназначен для использования с коллекциями.
