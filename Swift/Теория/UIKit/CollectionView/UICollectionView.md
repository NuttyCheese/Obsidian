...
5. **Источник данных и делегат:**
    ...
    - [[Swift/Теория/UIKit/CollectionView/UICollectionView]] взаимодействует с объектами, реализующими протоколы [[UICollectionViewDataSource]] и [[UICollectionViewDelegate]] для предоставления данных и обработки событий.
