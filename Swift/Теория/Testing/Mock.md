Вот **полное, подробное и максимально актуальное** (на 2026 год) руководство по **Mock-объектам** (имитациям) в unit-тестировании на Swift — с лучшими практиками, примерами и сравнением подходов.

### 1. Что такое Mock и зачем он нужен в 2026 году
...
> Используй **Fake**, если нужна полноценная имитация (например, in-memory CoreData).
...
Удачи с чистыми, быстрыми и надёжными тестами в Swift! 🧪