...
В Swift COW автоматически применяется ко всем встроенным коллекциям: [[Array]], [[Dictionary]], [[Set Collection]], [[String]]. Это позволяет сохранять семантику [[value type]]s (копирование при присваивании) без потери производительности на копирование больших объемов данных, если они фактически не изменяются.
...
4.  **Кастомные типы:** Можно реализовать COW для своих [[value type]]s, чтобы улучшить производительность .
