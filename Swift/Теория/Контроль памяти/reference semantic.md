...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- | ----------------------------------------- | ------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| **[[value semantic]]**        | [[struct]], [[enum]], [[tuple]], [[Array]], [[Dictionary]], [[Set Collection]], [[String]], [[Data]], [[Date]], [[CGPoint]] и т.д. | Копируется полностью (CoW — [[Copy-On-Write]]) | Изменение одной копии не влияет на другие | Да (если все свойства [[Sendable]])         | `var a = [1,2]; var b = a; b.append(3); // a остаётся [1,2]`                                    |
