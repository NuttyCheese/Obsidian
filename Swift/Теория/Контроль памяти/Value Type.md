...
| ------------------- | ---------------------------------------------- | --------------------- | --------------------------- | -------------------------- | ------------------------------ | ---------------------------------------------------------------------------------------- |
| **Value Types**     | [[struct]], [[enum]], [[tuple]], все примитивы | Копируется значение   | [[Stack]] или inline в куче | Нет                        | Нет                            | [[Int]], [[Double]], [[Bool]], [[String]], [[Array]], [[Dictionary]], [[Set Collection]], [[Point]] |
