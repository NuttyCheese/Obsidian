...
**`UITableViewCell`** — это **класс ячейки таблицы ([[Swift/Теория/Swift/UIKit/TableView/UITableView]])** в [[UIKit]], который отвечает за отображение **одной строки** в таблице.  
