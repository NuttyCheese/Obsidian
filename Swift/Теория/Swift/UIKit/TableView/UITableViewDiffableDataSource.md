`UITableViewDiffableDataSource` - это новый класс, введенный в [[iOS]] 13 и предназначенный для упрощения управления данными в таблицах ([[Swift/Теория/Swift/UIKit/TableView/UITableView]]). Он является частью нового подхода к управлению данными в таблицах, называемого "diffable data sources".
