# 📘 Protocol `Collection` в Swift — полное руководство

**`Collection`** — это базовый протокол для всех последовательностей элементов в [[Swift]], который расширяет **[[Sequence]]** и добавляет возможности доступа по индексу, подсчёта количества элементов и безопасной итерации.
