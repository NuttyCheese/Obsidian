Вот **полное, подробное и максимально актуальное** (на 2026 год) руководство по паттерну **Strategy (Стратегия)** в Swift — с современными идиоматичными реализациями, схемами и реальными iOS-сценариями.

### 1. Зачем Strategy нужен в Swift в 2026 году
...
- разные транспортные протоколы (REST, GraphQL, gRPC)
...
```mermaid
flowchart TD
    CheckoutViewModel[CheckoutViewModel] --> PaymentStrategy[PaymentStrategy протокол]
...
- **протокол + разные реализации** — когда нужна DI, тестируемость, A/B-тесты  
...
Удачи с гибким, тестируемым и современным поведением в Swift! 🔄