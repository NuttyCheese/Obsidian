Вот **полное, подробное и максимально актуальное** (на 2026 год) руководство по реализации **Singleton** в Swift — с честным анализом, почему его почти не используют в новом коде, и какие альтернативы предпочтительнее.
...
| Нарушение принципа инверсии зависимостей (DIP) | ViewModel / UseCase зависят от глобального объекта   | Нарушение SOLID      |
...
Удачи с чистым, тестируемым и безопасным глобальным состоянием в Swift! 🧭