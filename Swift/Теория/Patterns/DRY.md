Вот **полное, подробное и максимально актуальное** (на 2026 год) руководство по принципу **DRY** («Don't Repeat Yourself» — «Не повторяйся») в Swift.
...
- **Clean Swift / VIPER / MVVM-C** → DRY обязателен для UseCase / Interactor / Repository  
