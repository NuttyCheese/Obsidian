Вот **полное, подробное и максимально актуальное** (на февраль 2026 года) руководство по **Open-Closed Principle (OCP)** в Swift — с реальными iOS-примерами, схемами и сравнением архитектур.

### 1. Что такое Open-Closed Principle (OCP) — суть в 2026 году
...
| TCA / Composable Architecture / Clean Swift / VIPER | Требуют OCP как основу | Без OCP архитектура не работает |
...
Удачи с чистой, расширяемой и современной архитектурой в Swift! 🔄