### 1. Что такое Interface Segregation Principle(Принцип разделения интерфейса) (ISP) в 2026 году
...
- [[class]] / [[struct]] / [[actor]] должен реализовывать **только те протоколы**, которые ему действительно нужны  
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| Один большой протокол с 15–20 методами                                                                                                                                | Пустые реализации → нарушение [[Liskov Substitution Principle\|LSP]] и [[Open-Closed Principle\|OCP]] | Каждый протокол — узкий, только нужные методы    |
...
| [[Clean Swift (VIP) Architecture\|Clean Architecture]] / [[VIPER Architecture\|VIPER]] / [[TCA]] / [[MVVM (Model-View-ViewModel) Architecture\|MVVM]]-[[Coordinator]] | Требуют ISP как основу                                                                                | Без ISP архитектура рушится                      |
