Вот **полное, подробное и максимально актуальное** (на февраль 2026 года) руководство по **Liskov Substitution Principle (LSP)** в Swift — с примерами, схемами и реальными iOS-сценариями.

### 1. Что такое Liskov Substitution Principle (LSP) — суть в 2026 году
...
- Если класс/структура/актёр **реализует протокол** или **наследуется** от другого типа,  
...
| TCA / VIPER / Clean Swift / MVVM-C требуют LSP | Без LSP архитектура разваливается | LSP — основа чистой архитектуры |
