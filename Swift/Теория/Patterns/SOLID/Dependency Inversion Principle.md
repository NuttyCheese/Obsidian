### 1. Что такое Dependency Inversion Principle(Принцип инверсии зависимостей) (DIP) — суть в 2026 году
...
- [[Class]] / ViewModel / UseCase / Interactor **не должны** напрямую создавать или использовать конкретные реализации ([[URLSession]], [[Core Data]], [[Realm]], [[Firebase]] и т.д.)  
...
| [[Clean Swift (VIP) Architecture\|Clean Architecture]] / [[VIPER Architecture\|VIPER]] / [[TCA]] / Composable Architecture | Требуют DIP как основу                        | Без DIP архитектура разваливается |
