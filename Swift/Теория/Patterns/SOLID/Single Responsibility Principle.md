...
### 1. Что такое Single Responsibility Principle (SRP) — суть в 2026 году
...
- Каждый тип (класс, структура, актёр, протокол, ViewModel, UseCase и т.д.) должен отвечать **ровно за одну вещь**  
...
| TCA / Composable Architecture / Clean Swift / VIPER | Требуют SRP как основу | Без SRP архитектура не работает |
