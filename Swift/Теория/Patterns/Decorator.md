Вот **полное, подробное и максимально актуальное** (на 2026 год) руководство по паттерну **Decorator (Декоратор)** в Swift — с примерами, схемами, современными идиоматичными реализациями и сравнением подходов.

### 1. Зачем Decorator нужен в Swift в 2026 году

Decorator решает две главные проблемы:

- **Добавление поведения объекту динамически**, без изменения его класса  
- **Расширение функциональности без нарушения принципа открытости/закрытости (OCP)**  
...
|------------------------|-------------------------------------------------------------|-----------------------------|
| **Component**          | Протокол / базовый интерфейс                                | Обязателен (протокол)       |
...
flowchart TD
    ...
    subgraph "Декораторы (композиция)"
...
Удачи с красивым, расширяемым и современным кодом в Swift! 🎨