...
### 1. Что такое диспетчеризация в [[Swift]]
...
| Характеристика                  | Direct / Static          | Table Dispatch (vtable) | Witness Table           | Message Dispatch (objc_msgSend) |
|---------------------------------|--------------------------|--------------------------|-------------------------|----------------------------------|
...
| Поддержка протоколов            | Да (some / generics)     | Нет                      | Да                      | Да (если @objc)                  |
