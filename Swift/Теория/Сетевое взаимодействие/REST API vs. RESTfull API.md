...
| ------------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------- | ---------------------------------------------------------------- |
| **[[REST API]]**    | Любой [[API]], который **вдохновлён** принципами [[REST]] (часто использует [[HTTP]]-методы и ресурсы) | Средняя / низкая                    | Многие внутренние API компаний, старые проекты                   |
