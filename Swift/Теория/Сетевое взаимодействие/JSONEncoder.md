...
По состоянию на 2026 год ([[Swift]] 6+) `JSONEncoder` остаётся **основным и самым надёжным** инструментом для сериализации данных в [[JSON]] в [[iOS]]/macOS-приложениях. Он полностью поддерживает современный Swift ([[async]]/[[await]], strict concurrency, property wrappers, [[generic]]s) и активно используется Apple.
