Вот **полное, подробное и максимально насыщенное** руководство по **Data Corruption** (повреждению данных) в Swift и iOS-разработке — актуально на 2026 год.

Я включил:

- всю теорию и механизмы повреждения  
...
- типичные симптомы и как их обнаружить  
- все современные способы защиты (actor, Sendable, @MainActor, @globalActor, locks, queues и т.д.)  
...
### 1. Что такое Data Corruption (повреждение данных)
...
- **Неправильное использование value types** в многопоточной среде  
...
|-----------------------------------|----------------------------------------|----------------------------------|---------------|
| **Thread Sanitizer**              | Race conditions, data races            | Xcode → Scheme → Diagnostics     | ★★★★★         |
