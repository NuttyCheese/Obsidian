Вот **полное, подробное и максимально насыщенное** руководство по **Main Thread Violation** (нарушению главного потока) в Swift и iOS-разработке — актуально на февраль 2026 года.
