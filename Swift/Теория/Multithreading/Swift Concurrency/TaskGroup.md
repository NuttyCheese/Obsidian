Вот **полное, подробное и максимально актуальное** (на февраль 2026 года) руководство по **`TaskGroup`** в Swift Concurrency — включая все нюансы Swift 6 и строгой конкурентности.
...
Удачи с мощным, отменяемым и структурированным параллелизмом в Swift! 🚀