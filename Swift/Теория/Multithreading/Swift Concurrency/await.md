Вот **полное, подробное и максимально насыщенное** руководство по ключевому слову **`await`** в Swift — актуально на 2026 год (Swift 6+ и строгий режим конкурентности).
