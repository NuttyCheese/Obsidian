Вот **полное, подробное и максимально актуальное** (на 2026 год) руководство по методу **`addDependency`** класса `Operation` в Swift.

### 1. Что такое addDependency
...
Удачи с управляемыми зависимостями и современным кодом в Swift! 🚀