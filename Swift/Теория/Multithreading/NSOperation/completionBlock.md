Вот **полное, подробное и максимально актуальное** (на 2026 год) руководство по свойству **`completionBlock`** в классе `Operation` (включая `BlockOperation`) в Swift и iOS-разработке.

### 1. Что такое completionBlock
