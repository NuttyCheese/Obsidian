Вот **полное, подробное и максимально актуальное** (на 2026 год) руководство по **атомарным операциям** (atomic operations) в Swift.
...
| `Atomic<Bool>`               | Атомарный boolean                              | `load()`, `store()`, `exchange()`           | Флаги (вкл/выкл) |
