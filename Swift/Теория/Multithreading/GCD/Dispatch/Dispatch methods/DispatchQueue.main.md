Вот **полное, подробное и максимально актуальное** (на 2026 год) руководство по **`DispatchQueue.main`** в Swift и Grand Central Dispatch (GCD).
...
func loadUserProfile() {
    ...
    DispatchQueue.global(qos: .userInitiated).async {
        let profile = fetchProfile() // тяжёлая работа
