...
- **O(n)** по памяти и времени для мутабельных типов ([[Array]], [[Dictionary]], [[String]], [[Set Collection]] и т.д.)
...
| Подходит для                    | Числа, [[Bool]], [[enum]], маленькие строки | [[Array]], [[Dictionary]], [[Set Collection]], [[String]], [[struct]] | —             |
