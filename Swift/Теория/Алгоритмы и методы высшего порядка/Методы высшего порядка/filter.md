#swift #standard_library #higher_order_function #functional_programming #collection #sequence #predicate #boolean_filtering
...
Метод существует практически на всех типах, реализующих протокол [[Sequence]] (а значит — на [[Collection]], [[Array]], [[Set]], [[Dictionary]], [[String]], [[Range]], пользовательских последовательностях и т.д.).
