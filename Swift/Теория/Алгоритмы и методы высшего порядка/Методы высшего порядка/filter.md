...
Метод существует практически на всех типах, реализующих протокол [[protocol Sequence]] (а значит — на [[Collection]], [[Array]], [[Set Collection]], [[Dictionary]], [[String]], [[Range]], пользовательских последовательностях и т.д.).
...
- **Тип результата** обычно `[Element]`, но для некоторых типов ([[String]], [[Set Collection]]) — тот же тип
...
| [[Set Collection]]        | O(n)             | Нет хэширования при фильтрации               |
