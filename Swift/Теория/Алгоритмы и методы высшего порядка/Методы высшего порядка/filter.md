...
Метод существует практически на всех типах, реализующих протокол [[protocol Sequence]] (а значит — на [[Collection]], [[Array]], [[Set]], [[Dictionary]], [[String]], [[Range]], пользовательских последовательностях и т.д.).
