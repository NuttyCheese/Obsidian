...
flowchart TD
    ...
    Good --> ЛегчеТестировать["Легче тестировать"]
    Good --> МеньшеБагов["Меньше багов"]
    Good --> БыстрееРефакторинг["Быстрее рефакторинг"]
```

### 5. Лучшие практики DRY в Swift 2026

- **Правило трёх** — увидел код 3 раза → выноси в отдельную [[func]]/[[class]]/[[extension]]  
