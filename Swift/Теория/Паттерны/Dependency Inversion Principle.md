...
- [[class]] / ViewModel / UseCase / Interactor **не должны** напрямую создавать или использовать конкретные реализации ([[URLSession]], [[Core Data]], [[Swift/Теория/Сторонние библиотеки и расширения/Realm]], [[Firebase]] и т.д.)  
