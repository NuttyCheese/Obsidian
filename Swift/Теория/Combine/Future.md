...
|-----------------------------------------------|----------------------------------------------------------------|---------------------------------|
| Обёртка над completion-handler API            | Старые API (URLSession, CoreLocation, AVFoundation и т.д.)     | `Future` — классика |
...
Удачи с чистыми и надёжными асинхронными потоками в твоём проекте! 🔄