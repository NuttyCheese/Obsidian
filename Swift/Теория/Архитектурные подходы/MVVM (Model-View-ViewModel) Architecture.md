...
| Характеристика           | [[MVC (Model-View-Controller) Architecture\|MVC]] | [[MVP (Model-View-Presenter) Architecture\|MVP]] | MVVM                 | [[VIPER Architecture\|VIPER]] | [[Clean Swift (VIP) Architecture\|Clean Swift]] |
| ------------------------ | ------------------------------------------------- | ------------------------------------------------ | -------------------- | ----------------------------- | ----------------------------------------------- |
