#architecture #mvc #ios_development #design_pattern #ui_structure
...
*   **View:** Отвечает за визуальное отображение данных и взаимодействие с пользователем. Это [[Swift/Расширения/UIView]] и его сабклассы ([[UILabel]], [[UIButton]]). View должна быть максимально "глупой" — она отображает то, что ей говорят, и сообщает о действиях пользователя. **Не должна содержать логику или напрямую обращаться к Model.**
