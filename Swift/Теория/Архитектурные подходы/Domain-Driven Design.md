#ddd #domain_driven_design #software_architecture #modeling #ubiquitous_language #bounded_context #aggregates #entities #value_objects #ios #swift
...
- **[[Core Data]] или [[Realm]]**: можно использовать для хранения агрегатов.
