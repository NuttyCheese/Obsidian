...
| --------------------------- | ---------------------------------------- | -------------------------------- |
| **Локальный кэш**           | Данные хранятся в [[Core Data]]/[[Swift/Теория/Сторонние библиотеки и расширения/Realm]] | Новости доступны даже без сети   |
| **Prefetching**             | Подгружаем данные заранее                | [[Swift/Теория/UIKit/TableView/UITableView]] prefetch [[API]] |
...
2. Приложение загружает данные:
    ...
    - проверяет локальный кэш ([[Core Data]]/[[Swift/Теория/Сторонние библиотеки и расширения/Realm]]),
