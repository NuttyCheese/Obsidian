...
> [[Swift/System Design/3. Офлайн-режим и кэширование/Локальное хранение/Realm]], Core Data и SQLite — все три решения для локального хранения, но с разными уровнями абстракции.
