...
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- | ------------------------------------------------------------------- |
| Вызовы **[[Objective-C]] [[API]]** ([[UIKit]], [[AppKit]], Core Foundation, [[Swift/UserDefaults]], [[Core Data]], [[KVC]]/[[KVO]], NSNumberFormatter и т.д.) | Многие методы возвращают/принимают NSNumber    | Приводи сразу к Swift-типу: `number as? Int` / `number.doubleValue` |
