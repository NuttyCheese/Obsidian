**`Collection`** — это базовый протокол для всех последовательностей элементов в [[Swift]], который расширяет **[[Sequence 1]]** и добавляет возможности доступа по индексу, подсчёта количества элементов и безопасной итерации.
