...
| Сохранение значения в [[Swift/UserDefaults]] / [[Core Data]] | Не нужно сохранять каждый символ — только финальное значение | `UserDefaults.standard.set(text, forKey: "username")` |
