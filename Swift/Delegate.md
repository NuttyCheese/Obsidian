...
Используется для обратной связи между объектами без жёсткой связи между ними. Часто применяется в **UIKit** ([[Swift/Теория/UIKit/TableView/UITableView]], [[UITextField]] и др.).
