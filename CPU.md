...
3.  **Race Condition:** Когда два разных ядра CPU пытаются одновременно изменить одну и ту же переменную. Это приводит к багам. В [[Swift]] для этого есть семафоры и акторы ([[actor]]s).
