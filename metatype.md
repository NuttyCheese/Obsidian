...
| `T.Type`                | Сам тип metatype (как тип переменной/параметра)    | Метатип (метатип типа)         | В generics, параметрах функций |
...
Удачи с метатипами и динамическим кодом в твоём проекте! 🧬