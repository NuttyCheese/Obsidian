**CGFloat** — это псевдоним типа (type alias) в **Core Graphics**, который используется практически во всех случаях, когда нужно работать с координатами, размерами, отступами, масштабами и любыми другими значениями, связанными с экраном и графикой в iOS/macOS-приложениях.
...
Удачи с точным и пиксельно-идеальным интерфейсом в Swift! 📐